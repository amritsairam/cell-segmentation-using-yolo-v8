...
class DataValidation:
    def __init__(
        self,
        data_ingestion_artifact: DataIngestionArtifact,#this will contain the path to the folders and data.yaml files
        data_validation_config: DataValidationConfig,#this contains the dir names and the list of folders and files required for validation
    ):
        try:
        ...
        try:
            ...
            for file in all_files:
                if file not in(self.data_validation_config.required_file_list):
                    ...
                    os.makedirs(self.data_validation_config.data_validataion_dir,exist_ok=True)
